    ...
    class PanelDomotico
    {
        ...
        public PanelDomotico()
        {
            ...
            do
            {
                ...
                Console.Write("¿desea seguir añadiendo dispositivos? si/no: ");
                a = Console.ReadLine();
            } while (a == "si");
        }
        public void MostrarDispositivos()
        {
            ...
            {
                Console.WriteLine(d.Nombre + " " + d.Consumo);
            }
        }
        public void CalcularConsumoTotal()
        {
            ...
            Console.WriteLine("el consumo total de la casa es de: "+total);
        }
        public void DesconectarDispositivo()
        {
            Console.Write("ingresar nombre del dispositivo que quiere desconectar: ");
            string nombre = Console.ReadLine();
            for (int a = dispositivos.Count(); a >= 0; a--)
            {
